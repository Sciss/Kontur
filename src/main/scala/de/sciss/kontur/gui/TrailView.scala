...
//        "; unselected = " + unselected.toList )
  ...
  def editSelect( ce: AbstractCompoundEdit, stakes: T* ): Unit = editSetSelection( ce, stakes, state = true )

  def editDeselect( ce: AbstractCompoundEdit, stakes: T* ): Unit = editSetSelection( ce, stakes, state = false )
